...
## Limitações
Pelo escopo da atividade, não implementei funções avançadas como processamento de um vetor com valores negativos. Esse é um algoritmo relativamente simples, com foco apenas na lógica por trás do ordenamento de um vetor e não na sua utilização com um algoritmo verdadeiro.
